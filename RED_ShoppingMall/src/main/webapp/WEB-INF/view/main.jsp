						...
						<ul>
							<li data-transition='random' data-slotamount='7'
								...
								<div class='tp-caption LargeTitle sfl  tp-resizeme ' data-x='45'
									...
									data-elementdelay='0.1' data-endelementdelay='0.1'
									style='z-index: 3; white-space: nowrap;'>Black-Friday 특별展</div>
								...
								<div class='tp-caption Title sft  tp-resizeme ' data-x='45'
									...
									15 F/W 30~20% 가격인하!<br /> 아울렛 겨울 추가입고, 3만원 이상 무료배송
								</div>
								<div class='tp-caption Title sft  tp-resizeme ' data-x='45'
									...
									<strong>당신이 원하는 패션의 모든 것! POLO.,co 단독 특가전</strong>
								</div></li>
							<li data-transition='random' data-slotamount='7'
	...
	<div class="header-service wow bounceInUp animated">
		<div class="col-lg-3 col-sm-6 col-xs-3">
			<div class="content">
				...
				<span class="hidden-xs">7만원 이상 구매시 <strong>무료배송!</strong></span>
			</div>
		</div>
		<div class="col-lg-3 col-sm-6 col-xs-3">
			<div class="content">
				<div class="icon-support">&nbsp;</div>
				<span class="hidden-xs"><strong>고객 지원 서비스</strong> </span>
			</div>
		</div>
		<div class="col-lg-3 col-sm-6 col-xs-3">
			<div class="content">
				<div class="icon-money">&nbsp;</div>
				<span class="hidden-xs"><strong>3일 내 환불 보장!</strong> </span>
			</div>
		</div>
		<div class="col-lg-3 col-sm-6 col-xs-3">
			<div class="content">
				<div class="icon-dis">&nbsp;</div>
				<span class="hidden-xs"> 15만원 이상 구매시 <strong>5% 할인</strong></span>
			</div>
		</div>
	</div>
</div>
